...
$query = "SELECT visi, misi, sejarah, nama_ukm FROM tab_ukm WHERE id_ukm = 'mapala'";
...
$query = "SELECT nama_kegiatan, tgl FROM tab_kegiatan WHERE id_ukm = 'mapala'";
...
$query = "SELECT instagram, facebook FROM tab_ukm WHERE id_ukm = 'mapala'";
...
<nav class="navbar navbar-expand-md navbar-dark fixed-top">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
	...
	<div class="container">
        ...
        <div class="ukm-info">
        <div class="ukm-logo">
            <img src="<?php echo $logo_src; ?>" alt="Logo UKM Mapala" class="ukm-logo">
          </div>
            <div>
