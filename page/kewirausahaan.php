...
$query = "SELECT logo_ukm FROM tab_ukm WHERE id_ukm = 'kewirausahaan'";
...
$query = "SELECT visi, misi, sejarah, nama_ukm FROM tab_ukm WHERE id_ukm = 'kewirausahaan'";
...
$query = "SELECT nama_kegiatan, tgl FROM tab_kegiatan WHERE id_ukm = 'kewirausahaan'";
...
$query = "SELECT instagram, facebook FROM tab_ukm WHERE id_ukm = 'kewirausahaan'";
...
<html>
<head>
	<title>EKONOMI - SIUKM STMIK KOMPUTAMA MAJENANG</title>
  <meta charset="utf-8">
