...
<html>
<head>
	<title>WANACETA - SIUKM STMIK KOMPUTAMA MAJENANG</title>
    <meta charset="utf-8">
...
<nav class="navbar navbar-expand-md navbar-dark fixed-top">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
	...
	<div class="container">
        ...
        <div class="ukm-info">
            <div class="ukm-logo">
                <img src="..\assets\images\logoukm\wanaceta.jpg" alt="Logo UKM Wanaceta" class="ukm-logo">
            </div>
            <div>
                <h2>Sejarah Wanaceta</h2>
