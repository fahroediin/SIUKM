...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == 'add') {
   ...
   if (mysqli_query($conn, $insertQuery)) {
    ...
    header("Location: view_lpj.php?success=1");
    exit();
    } else {
...
<div class="content">
    ...
    $lpjQuery = "SELECT * FROM tab_lpj WHERE id_ukm = '$id_ukm'";
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="card">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" id="id_laporan" name="id_laporan" value="<?php echo generateUniqueId(); ?>" readonly>
                        ...
                        $ukmQuery = "SELECT id_ukm, nama_ukm FROM tab_ukm WHERE id_ukm = '$id_ukm'";
            ...
            <div class="form-group">
                ...
                <textarea id="saran" name="saran" placeholder="Isi dengan saran yang ditujukan untuk dosen pembimbing" class="form-control"></textarea>
            </div>
